...
import ar.com.algo2.jcmd.ui.helpers.ArgumentoDateFormatter;
import ar.com.algo2.jcmd.ui.listeners.AceptarListener;
import ar.com.algo2.jcmd.ui.listeners.DatePickerListener;
import ar.com.algo2.jcmd.ui.listeners.MenuItemAplicacionListener;
import ar.com.algo2.jcmd.ui.listeners.SeleccionarArchivoListener;

@SuppressWarnings("serial")
public class JCmdToolFrame extends JFrame {
	...
	public void dibujarArgumentos(Aplicacion aplicacion) throws Exception {
		...
		for (Argumento argumento: aplicacion.getArgumentos()) {
			...
			if (argumento.getTipo().equalsIgnoreCase("Search")) {
				...
				valorNumericoBinding.setConverter(new Converter<Long, String>() { //fix para devolver 0 cuando borra todo (valor numérico default)
